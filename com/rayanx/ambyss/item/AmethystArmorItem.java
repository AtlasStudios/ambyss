...
/*     */ 
/*     */ @Tag
/*     */ public class AmethystArmorItem extends AmbyssModElements.ModElement {
/*     */   @ObjectHolder("ambyss:amethyst_armor_helmet")
/*  24 */   public static final Item helmet = null;
/*     */   @ObjectHolder("ambyss:amethyst_armor_chestplate")
/*  26 */   public static final Item body = null;
/*     */   @ObjectHolder("ambyss:amethyst_armor_leggings")
/*  28 */   public static final Item legs = null;
/*     */   @ObjectHolder("ambyss:amethyst_armor_boots")
/*  30 */   public static final Item boots = null;
/*     */   public AmethystArmorItem(AmbyssModElements instance) {
/*  32 */     super(instance, 18);
/*     */   }
/*     */ 
/*     */   
...
/*  40 */           (new int[4])[0] = 13; (new int[4])[1] = 15; (new int[4])[2] = 16; (new int[4])[3] = 11; return (new int[4])[slot.func_188454_b()] * 50;
/*     */         }
/*     */ 
/*     */         
...
/*  60 */           return Ingredient.func_193369_a(new ItemStack[] { new ItemStack((IItemProvider)AmethystItem.block, 1) });
/*     */         }
/*     */ 
/*     */         
/*     */         @OnlyIn(Dist.CLIENT)
/*     */         public String func_200897_d() {
/*  66 */           return "amethyst_armor";
/*     */         }
/*     */ 
/*     */         
...
/*  82 */             return "ambyss:textures/models/armor/amethyst__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/*  88 */             return "ambyss:textures/models/armor/amethyst__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/*  94 */             return "ambyss:textures/models/armor/amethyst__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/* 100 */             return "ambyss:textures/models/armor/amethyst__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
...
/* Location:              D:\Webdev\Atlas Studios\rayanx.com\data\mods\ambyss.1.3.0.jar!\com\rayanx\ambyss\item\AmethystArmorItem.class
