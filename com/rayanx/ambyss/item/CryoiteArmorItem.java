...
/*     */ 
/*     */ @Tag
/*     */ public class CryoiteArmorItem extends AmbyssModElements.ModElement {
/*     */   @ObjectHolder("ambyss:cryoite_armor_helmet")
/*  24 */   public static final Item helmet = null;
/*     */   @ObjectHolder("ambyss:cryoite_armor_chestplate")
/*  26 */   public static final Item body = null;
/*     */   @ObjectHolder("ambyss:cryoite_armor_leggings")
/*  28 */   public static final Item legs = null;
/*     */   @ObjectHolder("ambyss:cryoite_armor_boots")
/*  30 */   public static final Item boots = null;
/*     */   public CryoiteArmorItem(AmbyssModElements instance) {
/*  32 */     super(instance, 61);
/*     */   }
/*     */ 
/*     */   
...
/*  40 */           (new int[4])[0] = 13; (new int[4])[1] = 15; (new int[4])[2] = 16; (new int[4])[3] = 11; return (new int[4])[slot.func_188454_b()] * 200;
/*     */         }
/*     */ 
/*     */         
...
/*  60 */           return Ingredient.func_193369_a(new ItemStack[] { new ItemStack((IItemProvider)CryoiteItem.block, 1) });
/*     */         }
/*     */ 
/*     */         
/*     */         @OnlyIn(Dist.CLIENT)
/*     */         public String func_200897_d() {
/*  66 */           return "cryoite_armor";
/*     */         }
/*     */ 
/*     */         
...
/*  82 */             return "ambyss:textures/models/armor/cryorite__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
/*     */         }).setRegistryName("cryoite_armor_helmet"));
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/*  88 */             return "ambyss:textures/models/armor/cryorite__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
/*     */         }).setRegistryName("cryoite_armor_chestplate"));
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/*  94 */             return "ambyss:textures/models/armor/cryorite__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
/*     */         }).setRegistryName("cryoite_armor_leggings"));
...
/*     */         {
/*     */           public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
/* 100 */             return "ambyss:textures/models/armor/cryorite__layer_" + ((slot == EquipmentSlotType.LEGS) ? "2" : "1") + ".png";
/*     */           }
/*     */         }).setRegistryName("cryoite_armor_boots"));
/*     */   }
/*     */ }


/* Location:              D:\Webdev\Atlas Studios\rayanx.com\data\mods\ambyss.1.3.0.jar!\com\rayanx\ambyss\item\CryoiteArmorItem.class
