...
/*     */ import com.rayanx.ambyss.item.SapphireItem;
...
/*     */ 
/*     */ @Tag
/*     */ public class SapphireOreBlock extends AmbyssModElements.ModElement {
/*     */   @ObjectHolder("ambyss:sapphire_ore")
/*  56 */   public static final Block block = null;
/*     */   public SapphireOreBlock(AmbyssModElements instance) {
/*  58 */     super(instance, 93);
...
/*  73 */     RenderTypeLookup.setRenderLayer(block, RenderType.func_228643_e_());
/*     */   }
/*     */   
/*     */   public static class CustomBlock extends Block { public CustomBlock() {
/*  77 */       super(AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(20.0F, 20.0F).func_235838_a_(s -> 0).harvestLevel(8)
/*  78 */           .harvestTool(ToolType.PICKAXE).func_235861_h_().func_226896_b_().func_235828_a_((bs, br, bp) -> false));
/*  79 */       setRegistryName("sapphire_ore");
/*     */     }
/*     */ 
/*     */     
...
/*  89 */       return new ItemStack((IItemProvider)SapphireOreBlock.block, 1);
/*     */     }
/*     */ 
/*     */     
...
/*  97 */       return Collections.singletonList(new ItemStack((IItemProvider)SapphireItem.block, 1));
/*     */     } }
/*     */   
...
/* 122 */       return SapphireOreBlock.CUSTOM_MATCH;
/*     */     } }
/*     */ 
/*     */   
...
/* 129 */       SapphireOreBlock.CUSTOM_MATCH = (IRuleTestType)Registry.func_218322_a(Registry.field_218363_D, new ResourceLocation("ambyss:sapphire_ore_match"), () -> SapphireOreBlock.CustomRuleTest.codec);
/* 130 */       SapphireOreBlock.feature = (Feature<OreFeatureConfig>)new OreFeature(OreFeatureConfig.field_236566_a_)
/*     */         {
...
/*     */           }
/*     */         };
/* 142 */       SapphireOreBlock.configuredFeature = (ConfiguredFeature)((ConfiguredFeature)((ConfiguredFeature)SapphireOreBlock.feature.func_225566_b_((IFeatureConfig)new OreFeatureConfig(SapphireOreBlock.CustomRuleTest.INSTANCE, SapphireOreBlock.block.func_176223_P(), 4)).func_242733_d(16))
/* 143 */         .func_242728_a()).func_242731_b(12);
/* 144 */       event.getRegistry().register(SapphireOreBlock.feature.setRegistryName("sapphire_ore"));
/* 145 */       Registry.func_218322_a(WorldGenRegistries.field_243653_e, new ResourceLocation("ambyss:sapphire_ore"), SapphireOreBlock.configuredFeature);
/*     */     }
...
/* Location:              D:\Webdev\Atlas Studios\rayanx.com\data\mods\ambyss.1.3.0.jar!\com\rayanx\ambyss\block\SapphireOreBlock.class
