...
/*    */ 
/*    */ @Tag
/*    */ public class SapphireBlockBlock
/*    */   extends AmbyssModElements.ModElement {
/*    */   @ObjectHolder("ambyss:sapphire_block")
/* 34 */   public static final Block block = null;
/*    */   public SapphireBlockBlock(AmbyssModElements instance) {
/* 36 */     super(instance, 98);
/*    */   }
/*    */ 
/*    */   
...
/* 53 */       super(AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(1.0F, 10.0F).func_235838_a_(s -> 0).harvestLevel(8)
/* 54 */           .harvestTool(ToolType.PICKAXE).func_235861_h_().func_226896_b_().func_235828_a_((bs, br, bp) -> false));
/* 55 */       setRegistryName("sapphire_block");
/*    */     }
/*    */ 
/*    */     
...
/* 65 */       return new ItemStack((IItemProvider)SapphireBlockBlock.block, 1);
/*    */     }
/*    */ 
/*    */     
...
/* Location:              D:\Webdev\Atlas Studios\rayanx.com\data\mods\ambyss.1.3.0.jar!\com\rayanx\ambyss\block\SapphireBlockBlock.class
