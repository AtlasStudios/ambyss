...
/*     */ import com.rayanx.ambyss.item.TopazItem;
...
/*     */ 
/*     */ @Tag
/*     */ public class TopazOreBlock extends AmbyssModElements.ModElement {
/*     */   @ObjectHolder("ambyss:topaz_ore")
/*  57 */   public static final Block block = null;
/*     */   public TopazOreBlock(AmbyssModElements instance) {
/*  59 */     super(instance, 91);
...
/*  78 */       super(AbstractBlock.Properties.func_200945_a(Material.field_151576_e).func_200947_a(SoundType.field_185851_d).func_200948_a(14.0F, 14.0F).func_235838_a_(s -> 0).harvestLevel(6)
/*  79 */           .harvestTool(ToolType.PICKAXE).func_235861_h_());
/*  80 */       setRegistryName("topaz_ore");
/*     */     }
/*     */     
/*     */     @OnlyIn(Dist.CLIENT)
...
/*  95 */       return new ItemStack((IItemProvider)TopazOreBlock.block, 1);
/*     */     }
/*     */ 
/*     */     
...
/* 103 */       return Collections.singletonList(new ItemStack((IItemProvider)TopazItem.block, 1));
/*     */     } }
/*     */   
...
/* 128 */       return TopazOreBlock.CUSTOM_MATCH;
/*     */     } }
/*     */ 
/*     */   
...
/* 135 */       TopazOreBlock.CUSTOM_MATCH = (IRuleTestType)Registry.func_218322_a(Registry.field_218363_D, new ResourceLocation("ambyss:topaz_ore_match"), () -> TopazOreBlock.CustomRuleTest.codec);
/* 136 */       TopazOreBlock.feature = (Feature<OreFeatureConfig>)new OreFeature(OreFeatureConfig.field_236566_a_)
/*     */         {
...
/*     */           }
/*     */         };
/* 148 */       TopazOreBlock.configuredFeature = (ConfiguredFeature)((ConfiguredFeature)((ConfiguredFeature)TopazOreBlock.feature.func_225566_b_((IFeatureConfig)new OreFeatureConfig(TopazOreBlock.CustomRuleTest.INSTANCE, TopazOreBlock.block.func_176223_P(), 4)).func_242733_d(16))
/* 149 */         .func_242728_a()).func_242731_b(12);
/* 150 */       event.getRegistry().register(TopazOreBlock.feature.setRegistryName("topaz_ore"));
/* 151 */       Registry.func_218322_a(WorldGenRegistries.field_243653_e, new ResourceLocation("ambyss:topaz_ore"), TopazOreBlock.configuredFeature);
/*     */     }
...
/* Location:              D:\Webdev\Atlas Studios\rayanx.com\data\mods\ambyss.1.3.0.jar!\com\rayanx\ambyss\block\TopazOreBlock.class
